...
public class ArrayExample {
	...
	public void ex2() {
		...
		int[] arr; // 배열 시작 주소 저장하는 변수 (참조형, 4byte)
		...
		// stack 영역은 컴파일러가 알아서 초기화X
		// heap 영역은 컴파일러가 알아서 초기화O
		int a;
...
//		The local variable a may not have been initialized
	...
	public void ex6() {
		...
		String[] menuArr = {"키토김밥", "포케", "샐러드", "닭가슴살+고구마", "쉐이크"};
		
		// 배열 index 범위 내에 난수 발생
	...
	public void ex7() {
		...
		// 인원수를 입력 받아 그 크기만큼의 정수 배열을 선언 및 할당
		// 인원수 만큼 점수를 입력 받아
		// 합계, 평균, 최고점, 최저점을 출력
...
//		System.arraycopy( arr, 0, copyArr, 0, arr.length);
	...
	public void ex11() {
		...
		if(arr1 != null) { // arr1이 참조하는 배열이 있을 때에만 수
