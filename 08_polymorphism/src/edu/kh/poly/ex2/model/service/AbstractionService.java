...
import edu.kh.poly.ex2.model.vo.LSW;
import edu.kh.poly.ex2.model.vo.LSWCalculator;
...
public class AbstractionService {
	...
	public void ex1() {
		...
		// 추상 클래스는 부모 타입의 참조 변수를 사용할 수 있다!
		// -> 다형성의 업캐스팅
		...
		// -> 동적 바인딩에 의해 정상 수행 될 것릏 알기 때문에 에러X
	...
	public void ex3() {
		...
		Calculator cal = new LSWCalculator();
