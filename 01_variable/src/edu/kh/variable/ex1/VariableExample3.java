...
public class VariableExample3 {
	...
	//main method : 자바 어플리케이션 실행 시 반드시 필요한 구문
	public static void main(String[] args) {
		...
		// 4. 특수 문자는 '$' , '_' 만을 허용한다.
		//    -> $는 내부 클래스 사용 시 자동으로 붙는 기호 (직접 사용X)
		...
		// 상수(final) : 항[상] 같은 [수]
		// -> JAVA에서의 의미 : 한번 값을 기록하면 값을 바꿀 수 없는 변수
		
		// 일반 변수
		int num2 = 200;
		num2 = 300; // 새로 대입 가능
		
		// 상수(대문자로 표기, 여러 단어이면 _로 구분)
		final int CONSTANT_NUMBER = 100000000; // 1억
		// final을 앞에 붙이면 마지막으로 값을 대입하는 변수를 의미
		// = 다시는 값을 대입 받지 않겠다.
		// = 변하지 않는 수(상수)
